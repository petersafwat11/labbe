...
export const authAPI = {
  ...
  updateHostAccountSettings: async (data) => {
    ...
    if (data.password && data.confirmPassword) {
      ...
      backendData.passwordConfirm = data.confirmPassword; // Map confirmPassword to passwordConfirm
    }

    return apiRequest("/auth/host/updateData", {
      method: "PATCH",
  ...
  sendEmailVerificationCode: async () => {
    return apiRequest("/auth/host/sendEmailVerificationCode", {
      method: "PATCH",
    });
  },
  ...
  verifyEmail: async (verificationCode) => {
    return apiRequest("/auth/host/verifyEmail", {
      method: "PATCH",
